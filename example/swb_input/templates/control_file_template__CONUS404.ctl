...
# ---------- CONUS404 NetCDF climate files -----------------------
PRECIPITATION NETCDF {precipitation_filename}
PRECIPITATION_GRID_PROJECTION_DEFINITION +proj=latlon +datum=WGS84 +lon_wrap=180
PRECIPITATION_NETCDF_Z_VAR             precipitation
...
TMAX_GRID_PROJECTION_DEFINITION +proj=latlon +datum=WGS84 +lon_wrap=180
...
TMIN_GRID_PROJECTION_DEFINITION +proj=latlon +datum=WGS84 +lon_wrap=180
...
DUMP_VARIABLES COORDINATES 217408 2385984
